...
public class FishtankBlockEntityRenderer2 implements BlockEntityRenderer<FishtankBlockEntity> {
    public FishtankBlockEntityRenderer2(BlockEntityRendererProvider.Context context){
    }
